...
**输入**：`/specs/001-insight-product-list/` 内的 plan/spec/research/data-model/contracts  
...
- [ ] T901 更新 quickstart 验收步骤与截图/说明（specs/001-insight-product-list/quickstart.md，必要时前端 README）
